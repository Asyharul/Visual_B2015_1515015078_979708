 ...
 * @author arul
 */
public class arul1 extends javax.swing.JFrame {

    /**
     * Creates new form arul1
     */
    public arul1() {
        initComponents();
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(NIM, javax.swing.GroupLayout.DEFAULT_SIZE, 234, Short.MAX_VALUE)
                            .addComponent(Nama)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(147, 147, 147)
    ...
    private void NamaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NamaKeyPressed
        ...
        if(evt.getKeyCode()== evt.VK_ENTER){
            if (Nama.getText().length() ==0){
                JOptionPane.showMessageDialog(this, "Masukan Kembali");
            }
                NIM.requestFocus();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(arul1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
